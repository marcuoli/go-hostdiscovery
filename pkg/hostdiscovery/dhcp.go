...
// 1. Reverse DNS (if DHCP server updates DNS) - primary method
// 2. DHCP INFORM request - queries DHCP server directly
// 3. Querying the DHCP server's lease database (requires access)
//
